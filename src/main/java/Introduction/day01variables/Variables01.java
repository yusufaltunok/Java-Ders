...
public class Variables01 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //System.out.println(shirtPrice + shoesPrice ); kısa yolu sout yaz enter
        ...
        //System.out.print();ekrana yazdırır ve pointer i bir sonraki satıra koyar

        //double data type:Virgullu sayilar icin kullanilır
        //double memoride daha fazla (8 byte) yer kaplar.
        //örnek 9:hücre ağırlığı ve amip ağırlığı için 2 tane variable oluştur ve ağırlık farkını yazdır.
