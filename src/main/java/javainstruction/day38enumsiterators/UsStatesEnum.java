...
public enum UsStatesEnum {
    ...
    // Enum: değişme ihtimali olmayan dataları depolamak için kullanılır(örnek: gun isimleri)
    // Değişmeyen sabit datalar buyuk harfle yazılır.
    ...
    private final String abbreviation; // kısaltma
    ...
    // Enum'ın ismi ile ulasacagımız için metodu static yaptık.
